...
> = /*@__PURE__*/ build<Vanilla${name}, ${name}Properties>(${canHaveChildren}, Vanilla${name})
    `
  ...
  writeFile(
    ...
    componentFolderNames
      ...
      .join('\n') +
      `\n\nexport { theme, setTheme, colors, defaultThemes, defaultProperties, borderRadius } from '@pmndrs/uikit-default'`,
  )
}
