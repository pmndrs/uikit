...
export const scrollbarAliasPropertyTransformation =
  createAliasPropertyTransformation(scrollbarAliases);

const transformAliases = {
  transformScale: ["transformScaleX", "transformScaleY", "transformScaleZ"],
} as const satisfies Aliases;

export const transformAliasPropertyTransformation =
  createAliasPropertyTransformation(transformAliases);
