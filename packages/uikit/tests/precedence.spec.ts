...
describe('properties precedence', () => {
  ...
  it('should merge properties when calling setProperties', async () => {
  ...
  it('should allow component properties to override classes', async () => {
  ...
  it('should apply later classes over earlier classes', async () => {
    StyleSheet['dim'] = { opacity: 0.3 }
  ...
  it('should fall back to defaults when no property is set', async () => {
    const root = new Container()
