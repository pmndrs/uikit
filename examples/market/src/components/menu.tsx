import { Button, Menubar, MenubarMenu, MenubarTrigger } from '@react-three/uikit-default'
import { Container, Svg, Text, getPreferredColorScheme, setPreferredColorScheme } from '@react-three/uikit'
